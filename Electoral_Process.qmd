---
title: Electoral Process Analysis
format: html
css: styles.css
---
...
house <- house <- read_csv("MP3/1976-2022-house.csv")

# Read in manually downloaded data from presidential elections
presidents <- read_csv("MP3/1976-2020-president.csv")
